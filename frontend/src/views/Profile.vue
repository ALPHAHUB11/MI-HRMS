        ...
        <div class="w-full sm:w-96">
          ...
          <div class="flex flex-col items-center mt-5 p-4">
            ...
            <a
              ...
              class="w-full shadow-sm py-3 mt-5 inline-flex items-center justify-center gap-2 bg-transparent border border-red-500 text-red-500 rounded-lg transition-all duration-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-300"
            >
              <!-- Icon before text -->
              <svg
